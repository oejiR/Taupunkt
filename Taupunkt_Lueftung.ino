...
#include "esp_task_wdt.h"  // Für Watchdog Timer
...
#define DHTTYPE_1 DHT22 // DHT 11
#define DHTTYPE_2 DHT22 // DHT 11
...
#define Korrektur_h_1  3  // Korrekturwert Innensensor Luftfeuchtigkeit
...
void setup() {
  // Watchdog Timer für ESP32
  esp_task_wdt_init(8, true); // Watchdog auf 8 Sekunden setzen
  esp_task_wdt_add(NULL); // Watchdog hinzufügen
  ...
  Wire.begin(SDA_PIN, SCL_PIN); // I2C Pins initialisieren
  lcd.init();
  lcd.backlight();
  lcd.setCursor(2,0);
